...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("all planes" + Arrays.toString(planes));
        System.out.println("Boing 747" + Arrays.toString(withTypeBoing747));
        System.out.println("Boing 999" + Arrays.toString(withTypeBoing999));
        System.out.println("withGreatInNameCount " + withGreatInNameCount);
        System.out.println("lessThan25Count " + lessThan25Count);
